...
public:
  ...
  void SaveOrderedPointCloudToFile(
      const std::vector<float> point_cloud, const glm::vec3 translation, const glm::quat rotation,
      int width, int height, const double timestamp);
